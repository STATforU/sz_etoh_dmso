...
Let's say we want to calculate the drop in total mobility for various ethanol concentrations between 0 and 2% if the capacitation of a sample without ethanol is 1.1. The calculation is:
